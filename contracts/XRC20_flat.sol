...
abstract contract TradeProxy {
    // This doesn't have to match the real contract name. Call it what you like.
    // function f1(bool arg1, uint arg2) public virtual returns(uint); // No implementation, just the function signature. This is just so Solidity can work out how to call it.
...
contract XRC20 is ERC20 {
    ...
    function burn(address to, uint256 amount) external tradeContractOnly {
        _burn(to, amount);
    }
